...
class ZPiece(
    ...
    ) : game.fabric.blockflow.domain.models.piece.Piece() {
    ...
    var currentRotation: game.fabric.blockflow.domain.models.piece.ZPiece.Rotation =
        game.fabric.blockflow.domain.models.piece.ZPiece.Rotation.LEFT
    ...
    override fun rotate() {
        ...
        currentRotation = when(currentRotation) {
            game.fabric.blockflow.domain.models.piece.ZPiece.Rotation.LEFT -> {
                rotateTop()
                game.fabric.blockflow.domain.models.piece.ZPiece.Rotation.TOP
            }
            game.fabric.blockflow.domain.models.piece.ZPiece.Rotation.TOP -> {
                rotateLeft()
                game.fabric.blockflow.domain.models.piece.ZPiece.Rotation.LEFT
